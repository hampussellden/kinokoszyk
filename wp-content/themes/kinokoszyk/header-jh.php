...
<body class="bg-kinoblack flex flex-col items-center h-screen text-white relative group font-body">
    ...
    <header class="bg-kinodeepblack pt-10 w-full flex flex-col items-center">
        <div class="lg:mb-4 flex flex-row lg:justify-center justify-between w-full lg:max-w-screen-md items-baseline">
            <a class="flex flex-row justify-center items-center gap-x-[20px] pl-5 sm:pl-10 lg:pl-0"
                href="<?= site_url() . "/joanna-helander/"; ?>">
                <img class="h-[20px] w-auto lg:h-[36px]" src="<?= get_template_directory_uri(); ?>/images/jhlogo.svg"
                    class="" />
                <h1 class="font-display text-2xl lg:text-5xl lg:font-bold lg:tracking-tight">
                    Joanna
                    Helander</h1>
            </a>
