...
?>
<div class="relative flex flex-col gap-[16px] border-b pb-[31px]">
    <h4 class="text-3xl">Explore Photographs</h4>
    <p><?php the_field('description'); ?></p>
    <div class="w-auto">
        <img class="w-[91.64%]" src="<?= $image['url']; ?>" alt="<?= $image['alt'] ?>">
        <button class="absolute flex flex-row justify-center items-center gap-[8px] p-[12px] bg-kinored text-kinowhite bottom-[31px] right-0 text-xl">Photographs
