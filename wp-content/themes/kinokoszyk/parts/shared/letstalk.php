<section class="w-full font-body py-5 sm:py-10 lg:py-20">
    ...
    <section class="pt-5 pb-8 px-5 bg-kinogrey md:px-10 md:pt-10 md:pb-14 lg:py-20 lg:pl-20">
        ...
        <div class="flex gap-7 md:gap-10 lg:gap-20">
            <a href="news-2" class="text-kinored">
                <button class="rounded-sm box-content text-sm px-5 py-3 border-solid box-border outline-none md:text-2xl md:px-8 hover:bg-kinowhite hover:text-kinored" style="box-shadow: inset 0 0 0 2px #751010;">
                    Articles
                </button>
            </a>
            <a href="contact" class="text-kinowhite">
                <button class="group flex gap-x-4 justify-center items-center text-kinowhite rounded-sm text-sm pl-5 pr-7 bg-kinored py-3 md:px-8 md:text-2xl hover:bg-kinowhite hover:text-kinored">
                    Contact us
