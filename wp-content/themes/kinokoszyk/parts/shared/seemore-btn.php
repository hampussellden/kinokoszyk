<button class="absolute flex flex-row justify-center items-center gap-[8px] p-[12px] bg-kinored text-kinowhite bottom-[31px] right-0 text-xl w-fit h-fit sm:static sm:pl-[32px] sm:pr-[32px] sm:pt-[13.9px] sm:pb-[13.9px] sm:gap-[24px] sm:text-[24px] cursor-pointer hover:bg-kinowhite hover:text-kinored">See more
