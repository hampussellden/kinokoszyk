...
<footer class="w-full bg-kinodeepblack">
    <section class="pl-5 md:flex justify-between items-center md:pl-10 md:py-20 md:pr-12 lg:pl-20 lg:py-16 lg:pr-40">
        <section class="py-10 flex flex-col gap-10 pr-10">
            ...
            <section>
                <a href="contact">
                    <button class="py-[13.9px] group flex gap-x-4 justify-center items-center text-kinowhite rounded-sm text-xl pl-5 pr-7 bg-kinored md:px-8 md:text-2xl hover:bg-kinowhite hover:text-kinored duration-200">
                        Contact us
