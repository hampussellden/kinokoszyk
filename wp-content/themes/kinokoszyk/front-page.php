    ...
    <section class="pt-5 pb-8 px-5 bg-kinogrey md:px-10 md:pt-10 md:pb-14 lg:py-20 lg:pl-20">
        ...
        <div class="flex gap-7">
            <a class="text-kinored">
                <button class="rounded-sm box-content text-sm px-5 py-3 border-solid box-border outline-none md:text-4xl" style="box-shadow: inset 0 0 0 2px #751010;">
                    Articles
                </button>
            </a>
            <a class="text-kinowhite">
                <button class="flex gap-x-4 justify-center items-center text-kinowhite rounded-sm text-sm pl-5 pr-7 py-3 bg-kinored md:pr-5 md:text-4xl">Contact us
